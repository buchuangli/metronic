...
public class RequestTypeBean extends WholePartBean implements BooleanCondition {
	...
	private final class Part0 extends DefaultPlainBean {
		...
		protected boolean doConditionIsTrue() {
			...
			List<TimeSlot> tsLit = rtb.getDailyStatus(startTime, endTime, client_id, project_id);
			Map map2 = null;
			...
			List<TimeSlot> countryList = rtb.getDailyCountryStatus(startTime, endTime, client_id, project_id,"中国");
			Map map3 = null;
			List list2 = new ArrayList();
			for (int i = 0; i < countryList.size(); i++) {
				map3 = new HashMap();
				map3.put("requestType", countryList.get(i).getRequestType());
				map3.put("requestNum", countryList.get(i).getRequestNum());
				list2.add(map3);
			}
			map1.put("gegrophyInfo", list2);
	...
	/*		startTime = 2016;
			...
			List<TimeSlot> countryList = rtb.getYearCountryStatus(startTime, endTime, client_id, project_id,"中国");
			Map map3 = null;
			List list2 = new ArrayList();
			for (int i = 0; i < countryList.size(); i++) {
				map3 = new HashMap();
	...
	private final class Part2 extends DefaultPlainBean {
		...
		/*	
			...
			List list1 = new ArrayList();
			List<TimeSlot> tsLit = rtb.getMonthStatus(startTime, endTime, client_id, project_id);
			Map map2 = null;
			for (int i = 0; i < tsLit.size(); i++) {
				map2 = new HashMap();
				map2.put("requestType", tsLit.get(i).getRequestType());
			...
			List<TimeSlot> countryList = rtb.getMonthCountryStatus(startTime, endTime, client_id, project_id,"中国");
			Map map3 = null;
			List list2 = new ArrayList();
			for (int i = 0; i < countryList.size(); i++) {
				map3 = new HashMap();
...
/*			startTime = 2016020100;
			...
			*/
			...
			List<TimeSlot> countryList = rtb.getHourCountryStatus(startTime, endTime, client_id, project_id,"中国");
			Map map3 = null;
			List list2 = new ArrayList();
			for (int i = 0; i < countryList.size(); i++) {
				map3 = new HashMap();
	...
	private final class Part5 extends DefaultPlainBean {
		...
		/*	startTime = 201602010000l;
			...
			List list1 = new ArrayList();
			List<TimeSlot> tsLit = rtb.getMinuteStatus(startTime, endTime, client_id, project_id);
			Map map2 = null;
			for (int i = 0; i < tsLit.size(); i++) {
				map2 = new HashMap();
				map2.put("requestType", tsLit.get(i).getRequestType());
			...
			List<TimeSlot> countryList = rtb.getMinuteCountryStatus(startTime, endTime, client_id, project_id,"中国");
			Map map3 = null;
			List list2 = new ArrayList();
			for (int i = 0; i < countryList.size(); i++) {
				map3 = new HashMap();
...
private final class Part6 extends DefaultPlainBean {
		...
		protected boolean doConditionIsTrue() {
			...
			List list1 = new ArrayList();
			List<TimeSlot> tsLit = rtb.getYearProvinceStatus(startTime, endTime, client_id, project_id, "中国", "beijing");
			Map map2 = null;
			for (int i = 0; i < tsLit.size(); i++) {
				map2 = new HashMap();
				map2.put("requestType", tsLit.get(i).getRequestType());
	...
	private final class Part7 extends DefaultPlainBean {
		...
		protected boolean doConditionIsTrue() {
			...
			List list1 = new ArrayList();
			List<TimeSlot> tsLit = rtb.getMonthProvinceStatus(startTime, endTime, client_id, project_id, "中国", "beijing");
			Map map2 = null;
			for (int i = 0; i < tsLit.size(); i++) {
				map2 = new HashMap();
				map2.put("requestType", tsLit.get(i).getRequestType());
	...
	private final class Part8 extends DefaultPlainBean {
		...
		protected boolean doConditionIsTrue() {
			...
			List list1 = new ArrayList();
			List<TimeSlot> tsLit = rtb.getDailyProvinceStatus(startTime, endTime, client_id, project_id, "中国", "beijing");
			Map map2 = null;
			for (int i = 0; i < tsLit.size(); i++) {
				map2 = new HashMap();
				map2.put("requestType", tsLit.get(i).getRequestType());
	...
	private final class Part9 extends DefaultPlainBean {
		...
		/*	if(StringUtils.isNotEmpty(st)){
			...
			List list1 = new ArrayList();
			List<TimeSlot> tsLit = rtb.getHourProvinceStatus(startTime, endTime, client_id, project_id, "中国", "beijing");
			Map map2 = null;
			for (int i = 0; i < tsLit.size(); i++) {
				map2 = new HashMap();
				map2.put("requestType", tsLit.get(i).getRequestType());
	...
	private final class Part10 extends DefaultPlainBean {
		...
		protected boolean doConditionIsTrue() {
			...
			List list1 = new ArrayList();
			List<TimeSlot> tsLit = rtb.getMinuteProvinceStatus(startTime, endTime, client_id, project_id, "中国", "beijing");
			Map map2 = null;
			for (int i = 0; i < tsLit.size(); i++) {
				map2 = new HashMap();
				map2.put("requestType", tsLit.get(i).getRequestType());
